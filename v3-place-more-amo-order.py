...
"""
        ...
        # Add price for order types that need it
        if order_type == "LIMIT" and price is not None:
            order_data["price"] = str(price)
        elif order_type == "STOP_LOSS" and price is not None:
            order_data["price"] = str(price)
        
        # Add trigger price for order types that need it
        ...
        print("\n=== ORDER REQUEST ===")
        print(f"URL: {DHAN_API_BASE}/orders")
